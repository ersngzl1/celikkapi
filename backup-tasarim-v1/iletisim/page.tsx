      ...
      <section className="relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #0F172A 0%, #1E293B 50%, #1E3A5F 100%)' }}>
        ...
        <div className="container-custom relative z-10 text-white" style={{ padding: '48px 24px 56px' }}>
          ...
          <h1 className="font-display text-4xl md:text-6xl font-extrabold leading-tight max-w-3xl" style={{ lineHeight: '1.1' }}>
            Bize <span className="text-red-400">Ulaşın</span>
          </h1>
          <p className="text-white/50 max-w-xl text-base md:text-lg leading-relaxed" style={{ marginTop: '16px' }}>
      ...
      <div className="container-custom" style={{ padding: '48px 24px 80px' }}>
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-8 lg:gap-14">
          ...
          <div className="order-2 lg:order-1">
            {isSubmitted ? (
              <div className="flex flex-col items-center justify-center text-center premium-card" style={{ padding: '80px 24px' }}>
                <div
                  className="flex items-center justify-center"
                  style={{ width: '64px', height: '64px', borderRadius: '20px', background: 'rgba(5, 150, 105, 0.1)', marginBottom: '24px' }}
                >
                  <CheckCircle2 style={{ width: '32px', height: '32px', color: '#059669' }} />
                </div>
                <h3 className="font-display text-2xl font-bold text-[var(--text-primary)]" style={{ marginBottom: '12px' }}>
                  Mesajınız Alındı
                </h3>
              ...
              <div className="premium-card" style={{ padding: '32px' }}>
                <h2 className="font-display text-xl font-bold text-[var(--text-primary)]" style={{ marginBottom: '4px' }}>Mesaj Gönderin</h2>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label style={{ display: 'block', fontSize: '11px', textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--text-muted)', marginBottom: '8px', fontWeight: 600 }}>
                        Ad Soyad *
                      </label>
                      <input
                        type="text"
                        ...
                        style={{
                          ...
                          background: 'var(--carbon-surface)', border: '1px solid var(--carbon-border)',
                  ...
                  <div>
                    ...
                    <select
                      ...
                      style={{
                        width: '100%', padding: '12px 16px',
                        background: 'var(--carbon-surface)', border: '1px solid var(--carbon-border)',
                        borderRadius: '12px', fontSize: '14px', color: 'var(--text-primary)', cursor: 'pointer',
                      }}
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      style={{
                        width: '100%', padding: '12px 16px',
                        background: 'var(--carbon-surface)', border: '1px solid var(--carbon-border)',
                        borderRadius: '12px', fontSize: '14px', color: 'var(--text-primary)', resize: 'none',
                      }}
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2 text-white font-bold rounded-xl transition-all duration-300 cta-glow disabled:opacity-50 disabled:cursor-not-allowed"
                    style={{
                      padding: '14px 32px',
          ...
          <div className="order-1 lg:order-2">
            <div className="lg:sticky lg:top-24" style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {contactInfo.map((info) => (
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    >
                      <info.icon style={{ width: '18px', height: '18px', color: info.color }} />
                    </div>
                    <div>
                      ...
                      {info.href ? (
                        <a
                          href={info.href}
                          className="text-sm font-bold text-[var(--text-primary)] hover:text-red-600 transition-colors"
                        >
                          {info.value}
                        </a>
                      ) : (
              ...
              {/* Map placeholder */}
              <div className="premium-card overflow-hidden" style={{ aspectRatio: '4/3' }}>
                <div className="w-full h-full flex flex-col items-center justify-center" style={{ background: 'var(--carbon-surface)' }}>
                  <div style={{
