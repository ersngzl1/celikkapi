...
export default function Footer() {
  ...
  return (
    <footer>
      {/* Pre-footer CTA */}
      <div style={{ background: 'linear-gradient(135deg, #0A0A0A 0%, #161616 50%, #0A0A0A 100%)', borderTop: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }} className="relative overflow-hidden">
        ...
        <div className="absolute top-0 right-0 w-64 h-64 rounded-full blur-3xl" style={{ background: 'rgba(200, 165, 92, 0.04)' }} />
        <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full blur-3xl" style={{ background: 'rgba(200, 165, 92, 0.03)' }} />
        ...
        <div className="container-custom relative z-10" style={{ padding: '48px 24px' }}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto flex-shrink-0">
              ...
              <a href="tel:+903221234567" className="flex items-center justify-center gap-2 font-bold rounded-xl transition-colors text-sm whitespace-nowrap cta-gold" style={{ padding: '14px 24px', background: 'linear-gradient(135deg, var(--gold), var(--gold-dark))', color: 'var(--bg-primary)' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
                  ...
                  <>
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: '0 2px 8px rgba(200, 165, 92, 0.25)',
                      }}
                    >
            ...
            <div>
              ...
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                ...
                <li className="flex items-start gap-3">
                  <div className="flex items-center justify-center flex-shrink-0" style={{ width: '32px', height: '32px', borderRadius: '8px', background: 'rgba(200, 165, 92, 0.08)', border: '1px solid rgba(200, 165, 92, 0.12)' }}>
                    <Phone className="w-4 h-4 text-[var(--gold)]" />
                  </div>
                  <div>
                    <a href="tel:+903221234567" className="text-sm font-bold text-[var(--text-primary)] hover:text-[var(--gold-light)] transition-colors">(0322) 123 45 67</a>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <a href="mailto:info@bestkapi.com" className="text-sm text-[var(--text-secondary)] hover:text-[var(--gold-light)] transition-colors">info@bestkapi.com</a>
                </li>
                <li className="flex items-start gap-3">
                  <div className="flex items-center justify-center flex-shrink-0" style={{ width: '32px', height: '32px', borderRadius: '8px', background: 'rgba(200, 165, 92, 0.08)', border: '1px solid rgba(200, 165, 92, 0.12)' }}>
