            ...
            <div className="sticky top-20 space-y-4">
              <div className="aspect-[3/4] rounded-2xl relative overflow-hidden" style={{ border: '1px solid var(--border)' }}>
                ...
                <div className="absolute top-4 left-4 flex flex-col gap-1.5 z-10">
                  <span className="text-[10px] uppercase tracking-wider px-3 py-1.5 rounded-full font-bold" style={{ background: 'linear-gradient(135deg, var(--gold), var(--gold-dark))', color: 'var(--bg-primary)' }}>{door.category}</span>
                </div>
                <div className="absolute top-4 right-4 flex items-center gap-2 px-2.5 py-1.5 rounded-full z-10" style={{ background: 'rgba(10, 10, 10, 0.7)', backdropFilter: 'blur(8px)', border: '1px solid var(--border)' }}>
