          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8">
              <a
                ...
                className="gtm-whatsapp flex-1 flex items-center justify-center gap-2 px-6 py-4 bg-[#25D366] text-white font-bold rounded-xl hover:bg-[#20BD5A] transition-colors shadow-md wa-glow text-[15px]"
              >
              ...
              <a
                ...
                className="gtm-phone flex items-center justify-center gap-2 px-6 py-4 font-bold rounded-xl transition-colors cta-gold"
