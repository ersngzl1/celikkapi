  ...
  return (
    <div className="group">
      ...
      >
        ...
        >
          {/* Handle */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-7 h-7 md:w-10 md:h-10 rounded-full shadow-lg flex items-center justify-center" style={{ background: 'linear-gradient(135deg, var(--gold), var(--gold-dark))', border: '2px solid rgba(255,255,255,0.3)' }}>
