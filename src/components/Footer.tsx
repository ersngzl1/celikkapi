        ...
        <div className="container-custom relative z-10" style={{ padding: '48px 24px' }}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto flex-shrink-0">
              <a href={waLink} target="_blank" rel="noopener noreferrer" onClick={() => trackWhatsApp("footer")} className="flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold rounded-xl hover:bg-[#20BD5A] transition-colors text-sm wa-glow whitespace-nowrap" style={{ padding: '14px 24px' }}>
              ...
              <a href={`tel:${settings.phone.replace(/[^0-9+]/g, "")}`} onClick={() => trackPhone("footer")} className="flex items-center justify-center gap-2 font-bold rounded-xl transition-colors text-sm whitespace-nowrap cta-gold" style={{ padding: '14px 24px', background: 'linear-gradient(135deg, var(--gold), var(--gold-dark))', color: '#FFFFFF' }}>
