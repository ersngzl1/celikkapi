        ...
        <div className="container-custom relative z-10" style={{ padding: '48px 24px' }}>
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto flex-shrink-0">
              <a href={waLink} target="_blank" rel="noopener noreferrer" onClick={() => trackWhatsApp("footer")} className="gtm-whatsapp flex items-center justify-center gap-2 bg-[#25D366] text-white font-bold rounded-xl hover:bg-[#20BD5A] transition-colors text-sm wa-glow whitespace-nowrap" style={{ padding: '14px 24px' }}>
              ...
              <a href={`tel:${settings.phone.replace(/[^0-9+]/g, "")}`} onClick={() => trackPhone("footer")} className="gtm-phone flex items-center justify-center gap-2 font-bold rounded-xl transition-colors text-sm whitespace-nowrap cta-gold" style={{ padding: '14px 24px', background: 'linear-gradient(135deg, var(--gold), var(--gold-dark))', color: '#FFFFFF' }}>
                <Phone className="w-4 h-4 flex-shrink-0" /> {settings.phone}
              </a>
              <Link href="/iletisim" onClick={() => trackTeklif("footer")} className="flex items-center justify-center gap-2 text-white font-bold rounded-xl transition-colors text-sm whitespace-nowrap" style={{ padding: '14px 24px', border: '1px solid rgba(255,255,255,0.2)' }}>
            ...
            <div>
              ...
              <ul style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <a href={waLink} target="_blank" rel="noopener noreferrer" className="gtm-whatsapp text-sm font-bold text-[#25D366] hover:text-[#20BD5A] transition-colors">WhatsApp ile Yazın</a>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <a href={`tel:${settings.phone.replace(/[^0-9+]/g, "")}`} className="gtm-phone text-sm font-bold text-[var(--text-primary)] hover:text-[var(--gold-light)] transition-colors">{settings.phone}</a>
