      ...
      <div style={{ background: 'var(--bg-secondary)', borderBottom: '1px solid var(--border)' }} className="hidden md:block text-xs">
        <div className="container-custom flex items-center justify-between" style={{ padding: '8px 0' }}>
          <div className="flex items-center gap-5">
            <a href={waLink} target="_blank" rel="noopener noreferrer" className="gtm-whatsapp flex items-center gap-1.5 hover:text-[#25D366] transition-colors font-semibold text-[var(--text-secondary)]">
            ...
            <a href={`tel:${settings.phone.replace(/[^0-9+]/g, "")}`} className="gtm-phone flex items-center gap-1.5 text-[var(--text-muted)] hover:text-[var(--gold-light)] transition-colors">
        ...
        <div className="container-custom flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <a href={waLink} target="_blank" rel="noopener noreferrer"
              ...
              className="gtm-whatsapp flex items-center gap-2 text-white text-sm font-bold rounded-xl hover:bg-[#20BD5A] transition-all duration-300 wa-glow"
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <a href={waLink} target="_blank" rel="noopener noreferrer"
              ...
              className="gtm-whatsapp flex items-center justify-center rounded-xl bg-[#25D366] text-white wa-glow"
            ...
            <a href={`tel:${settings.phone.replace(/[^0-9+]/g, "")}`}
              ...
              className="gtm-phone flex items-center justify-center rounded-xl text-white cta-gold"
